...
public class BoardManager : MonoBehaviour
{
    ...
    public void SetupScene()
    {
        ...
        string escenario = "60 60                                                       \n" +
                           ...
                           "EF            EF                            EF            EF\n" +
                           "EF            EF                            EF            EF\n" +
                           "EF            EF   hhhhh       ttttt        EF            EF\n" +
                           "EF   Áccccá   EF   hhhhh       ttttt        EF   Áaaaaá   EF\n" +
                           "EF   Éccccé   IJ   hhhhh       ttttt        IJ   Éaaaaé   EF\n" +
                           "EF   Íccccí   EF   hhhhh       ttttt        EF   Íaaaaí   EF\n" +
                           "EF   Óccccó   EF   hhhhh                    EF   Óaaaaó   EF\n" +
                           "EF            EF                            EF            EF\n" +
                           "EF            EF                            EF            EF\n" +
                           "71555555555555415555G555555555555555G55555554155555555555548\n" +
                           "7B666666666666666666H666666666666666H666666666666666666666D8\n" +
                           "EF         ffff                         ggggg  MMMMMMMMMMMEF\n" +
                           "EF         fffff                        ggggg  MMMMMMMMMMMEF\n" +
                           "EFttttt    fffff                        ggggg  MMMMMMMMMMMEF\n" +
                           "EFttttt    ffff                         ggggg  MMMMMMMMMMMEF\n" +
                           "EFttttt                 pppppppppp      ggggg             EF\n" +
                           "EFttttt                 pppppppppp                        EF\n" +
                           "EF                      pppppppppp                        EF\n" +
                           "EF                      pppppppppp                        EF\n" +
                           "EF                      pppppppppp                        EF\n" +
                           "EF        ggggg         pppppppppp                        EF\n" +
                           "EFddddd   ggggg         pppppppppp              ffff      EF\n" +
                           "EFddddd   ggggg         pppppppppp              fffff  eeeEF\n" +
                           "EFddddd   ggggg                                 fffff  eeeEF\n" +
                           "EFddddd   ggggg                                 ffff   eeeEF\n" +
                           "EF                                                        EF\n" +
                           "EF                                                        EF\n" +
        ...
        for (int pl = 0; pl < ptotal; pl++)
        {
            ...
            {
                case 'P':
                    instance = Instantiate(player, new Vector3(Convert.ToInt32(jugadores[pl+1].Split(' ')[1]), Convert.ToInt32(jugadores[p + 1].Split(' ')[2]), 0f), Quaternion.identity);
                    break;

                case 'V':
                    instance = Instantiate(enemigov, new Vector3(Convert.ToInt32(jugadores[pl + 1].Split(' ')[1]), Convert.ToInt32(jugadores[p + 1].Split(' ')[2]), 0f), Quaternion.identity);
                    break;

                case 'H':
                    instance = Instantiate(enemigoh, new Vector3(Convert.ToInt32(jugadores[pl + 1].Split(' ')[1]), Convert.ToInt32(jugadores[p + 1].Split(' ')[2]), 0f), Quaternion.identity);
                    break;
            }
